...
[KNOWN-ISSUES.md](docs/KNOWN-ISSUES.md) rather than defended.
...
[ADR-0001](docs/adr/0001-tabular-parsing-is-our-own-cursor.md) holds a **different and
...
| | |
|---|---|
| [KNOWN-ISSUES.md](docs/KNOWN-ISSUES.md) | What review found and we chose not to fix yet, with what would make each one matter |
| [IDEAS.md](docs/IDEAS.md) | What the design would accommodate and nobody has asked for |
| [ADR-0001](docs/adr/0001-tabular-parsing-is-our-own-cursor.md) | Why the parsing is ours, with the measurements the choice was made on |
...
re-thought from scratch in a year: [IDEAS.md](docs/IDEAS.md).
